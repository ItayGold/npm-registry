...
export class ClickMeseageDialogDemoComponent implements OnInit {
  ...
  constructor(private messageDialogService: ClickMessageDialogService) {
    ...
    this.errorDialogData.message =
      "Analytics hasn't been set up yet. Please follow the setup instructions as described in the documentation.";
    ...
    this.warningDialogData.message =
      "Analytics hasn't been set up yet. Please follow the setup instructions as described in the documentation.";
